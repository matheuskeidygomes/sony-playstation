...
export default function Menu(props) {
    ...
    return <>
        ...
        <nav className={`${props.display} md:block ml-8`}>
            ...
            <ul className={`flex flex-col md:flex-row md:min-h-fit md:static ${props.menuActive && "items-center min-h-full w-full p-5 fixed top-0 right-0 animate-slide bg-[#ffffff0d] backdrop-blur-lg md:bg-transparent"}`}>
