...
export default function Menu(props) {
    ...
    return <>
        ...
        <nav className={`${props.display} ml-8 md:block`}>
            ...
            <ul className={`flex flex-col ${props.menuActive ? "animate-slide items-center w-80 glassmorphism  absolute top-0 right-0 min-h-screen p-5" : ""} md:flex-row md:static md:min-h-fit`}>
                ...
                <div className="md:hidden">
                    ...
                    <Social menuActive={props.menuActive} flex="flex-row"/>
