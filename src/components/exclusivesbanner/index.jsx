...
export default function ExclusiveGames() {
    ...
    return <>
        ...
        <div className="flex justify-center items-center bg-cover bg-no-repeat bg-center border-t-2 border-b-2 border-gray-900" style={{ backgroundImage: `url(${Exclusives})`, height: 400 }}>

            <div className="flex flex-col justify-center items-center p-5 w-72 h-72 md:w-80 md:h-80 bg-black rounded-md text-center opacity-70">
